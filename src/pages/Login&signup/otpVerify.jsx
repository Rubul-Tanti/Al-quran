...
e.preventDefault()
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-blue-50 text-white">
      <div className="bg-white rounded-2xl shadow-lg p-8 w-[350px] flex flex-col gap-4 text-blue-900">
        ...
        <input
          ...
          maxLength={6}
          ref={otp}
          className="w-full px-4 py-2 border-2 border-blue-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 text-center tracking-widest text-xl"
