          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full px-4 py-2.5 border border-zinc-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all pr-11"
              />
              <button
                type="button"
              ...
              <input
                ...
                className={`w-full px-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 transition-all pr-11 ${
                  passNotMatch 
                    ...
                    : "border-zinc-300 focus:ring-blue-500 focus:border-transparent"
                }`}
              />
              <button
                type="button"
              ...
              {["Male", "Female", "Other"].map((g) => (
                ...
                >
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="w-4 h-4 text-blue-500 border-zinc-300 focus:ring-2 focus:ring-blue-500 cursor-pointer"
                  />
