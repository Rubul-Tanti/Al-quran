...
const navigate=useNavigate()
  ...
  return (
    <div className="min-h-screen relative flex flex-col items-center justify-center  px-4 text-center">
      <h1 className="text-2xl md:text-3xl font-semibold mb-6 text-blue-900">
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-6">
        ...
        >
          <div className="flex items-center justify-between">
            <div className="text-left">
              <FaChalkboardTeacher size={28} className="text-blue-900 mb-2" />
              <h2 className="text-lg font-semibold text-blue-900">
                I'm a tutor, ready to teach Quran
              </h2>
            </div>
            <input
              type="radio"
        ...
        >
          <div className="flex items-center justify-between">
            <div className="text-left">
              <FaBookOpen size={28} className="text-blue-900 mb-2" />
              <h2 className="text-lg font-semibold text-blue-900">
                I'm a student, eager to learn Quran
              </h2>
            </div>
            <input
              type="radio"
      ...
      <p className="text-sm text-gray-600 mt-4">
        ...
        <a href="/login" className="text-blue-900 font-medium underline">
          Log In
        </a>
      </p>
    </div>
