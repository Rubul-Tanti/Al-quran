             ...
             <div className="flex justify-center items-center w-full md:w-1/3 bg-white p-6 sm:p-8 shadow-lg min-h-[50vh] md:min-h-screen mt-5 overflow-hidden">
               <div className="flex flex-col items-start gap-4 w-full max-w-sm">
                 ...
                 <input
                   ...
                   />
                   <button onClick={getotp} className="w-[100px] cursor-pointer h-12 rounded-lg bg-blue-900 hover:bg-blue-800 transition text-white font-semibold text-sm sm:text-base">Get otp</button>
                  {otpsent===true&&<button onClick={getotp} className="w-[100px] cursor-pointer h-12 rounded-lg border border-blue-900  transition text-blue-900 font-semibold text-sm sm:text-base">resend otp</button>} 
                   </div>
                 ...
                 <button onClick={handleonSignup} className="w-full py-3 rounded-lg bg-blue-900 hover:bg-blue-800 transition text-white font-semibold text-sm sm:text-base">
                   Sign Up
                 </button>
