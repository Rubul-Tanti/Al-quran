    ...
    <section className="bg-blue-50 py-16 px-6 md:px-12 lg:px-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-lg transition">
          <h3 className="text-2xl font-bold text-blue-800 mb-6 text-center">For Teachers</h3>
          <ul className="space-y-6">
            <li className="flex items-start gap-4">
              <FaUserPlus className="text-blue-900 text-3xl" />
              <div>
            ...
            <li className="flex items-start gap-4">
              <FaCalendarCheck className="text-blue-900 text-3xl" />
              <div>
        ...
        {/* For Students */}
        <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-lg transition">
          <h3 className="text-2xl font-bold text-blue-800 mb-6 text-center">For Students</h3>
          <ul className="space-y-6">
            <li className="flex items-start gap-4">
            ...
            <li className="flex items-start gap-4">
              <FaPlay className="text-blue-900 text-3xl" />
              <div>
