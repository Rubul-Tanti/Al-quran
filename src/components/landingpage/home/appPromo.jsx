      ...
      <div className="mx-auto flex flex-row md:flex-row items-center justify-center gap-12">
        ...
        <div className="flex-1 text-center md:text-left">
          <h2 className="text-4xl font-bold text-gray-800 mb-4">
            One Platform to <span className="text-blue-900">Learn or Teach Quran</span><br />
            All in Your Pocket
          </h2>
          ...
          <div className="flex flex-row sm:flex-row gap-4 justify-center md:justify-start">
            <a
              href="#"
              className="flex items-center gap-2 bg-blue-900 text-white px-5 py-3 rounded-full hover:bg-blue-800 transition"
            >
            ...
            <a
              href="#"
              className="flex items-center gap-2 border-2 border-blue-900 text-blue-900 px-5 py-3 rounded-full hover:bg-blue-100 transition"
            >
