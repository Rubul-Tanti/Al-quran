...
export default function PlansFlipCard() {
      ...
      <div className={`flip-card ${flipped ? "flipped" : ""}`}>
        <div className="flip-card-inner">
          ...
          <div className="flip-card-front bg-gradient-to-br from-blue-50 to-white text-white  flex items-center justify-center">
            <h2
              ref={titleRef}
              className="text-3xl text-blue-900 md:text-4xl font-bold tracking-wide"
            >
              Our <span className="text-blue-500">Plans</span> 
            </h2>
          </div>

          {/* Back Face */}
         <div className="flip-card-back bg-white text-blue-900 p-8 items-center  flex flex-col gap-12">
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-16 w-5/6 ">
    {/* Basic Plan */}
    <div className="rounded-2xl border border-blue-200 p-6 shadow-md hover:shadow-xl transition">
      ...
      <div className="text-center text-3xl font-bold text-blue-800">$19<span className="text-base font-medium">/month</span></div>
      <button className="mt-4 w-full bg-blue-100 text-blue-800 py-2 rounded-lg font-medium">Current Plan</button>
      <ul className="mt-6 space-y-2 text-sm">
        <li>✔ 2 Quran classes/week</li>
    ...
    <div className="rounded-2xl border border-green-300 p-6 shadow-lg hover:shadow-xl transition scale-105">
      ...
      <ul className="mt-6 space-y-2 text-sm">
        <li>✔ 4 Quran classes/week</li>
        <li>✔ Tajweed + Memorization</li>
    ...
    <div className="rounded-2xl border border-blue-300 p-6 shadow-md hover:shadow-xl transition">
      ...
      <div className="text-center text-3xl font-bold text-blue-800">$69<span className="text-base font-medium">/month</span></div>
      <button className="mt-4 w-full bg-blue-500 text-white py-2 rounded-lg font-semibold hover:bg-blue-600">Get Premium</button>
      <ul className="mt-6 space-y-2 text-sm">
        <li>✔ Daily Quran classes</li>
        <li>✔ Advanced Tajweed & Tafsir</li>
