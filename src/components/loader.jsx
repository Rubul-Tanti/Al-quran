  ...
  return (
    <div className={`flex items-center justify-center ${config.container}`}>
      <div className="relative">
        ...
        {(size === 'medium' || size === 'large') && (
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            {[0, 1, 2, 3].map((i) => (
              <div
                key={i}
                className={`absolute ${config.dotSize} bg-blue-400 rounded-full animate-ping`}
                style={{
        ...
        {size === 'large' && (
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            ...
            <div
              className={`absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 ${config.rippleSize2} border-2 border-blue-200 rounded-full animate-ping opacity-20`}
      ...
      {variant === 'default' && (size === 'medium' || size === 'large') && (
        <div className={`${config.spacing} text-blue-900 font-semibold ${config.textSize}`}>
