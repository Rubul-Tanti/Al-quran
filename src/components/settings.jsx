    ...
    <div className="min-h-screen overflow-hidden bg-blue-50 flex flex-col md:flex-row">
      ...
      <div className="bg-white shadow-lg border-b md:border-b-0 md:border-r w-full md:w-64 p-4">
        ...
        <Link
            ...
            className="flex h-12 items-center gap-2 text-blue-900 font-semibold"
          >
          <IoIosArrowBack size={20} />
        <h2 className="hidden md:block text-xl font-bold text-blue-900 ">
           Settings
        </h2>
          </Link>
      ...
      <div className="flex-1 p-4 md:p-8">
          ...
          <section>
            ...
            <div className="space-y-4">
              <input
                ...
                className="border p-3 rounded-lg w-full focus:ring-2 focus:ring-blue-900 outline-none"
              />
              <input
                type="email"
        ...
        {active === "appearance" && (
          <section>
            <h3 className="text-2xl font-bold text-blue-900 mb-4">Appearance</h3>
            <select
              value={theme}
        ...
        {active === "language" && (
          <section>
            <h3 className="text-2xl font-bold text-blue-900 mb-4">Language</h3>
            <select
              value={language}
