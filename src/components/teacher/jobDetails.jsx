        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="border-b border-gray-200 pb-6">
            ...
            <p className="text-sm text-gray-500 flex items-center gap-2">
              ...
              <span className="text-blue-500">Posted on</span> {formattedDate}
            </p>
          </div>
          ...
          <section className="border-t border-gray-200 pt-8">
            ...
            <form onSubmit={(e) => { sendProposal(e, { proposal: proposal.current.value }) }} className="space-y-4">
              ...
              <button
                type="submit"
                className="bg-blue-500 text-white px-6 py-3 rounded-lg hover:bg-gray-800 transition flex items-center gap-2 font-medium"
              >
                <FiSend />
                Submit Proposal
              </button>
